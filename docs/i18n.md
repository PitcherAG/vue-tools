...
If you don't need translation but just the number and date formatting: await `setLanguage('en', {load: false})`
...
3. edit .po files
4. transform .po file to json with `npm run config-gettext-compile`
