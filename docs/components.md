...
| `search-options` | `Object` | no | ```{ threshold: 0.3 }``` | fuse.js search options, default threshold is 0.3 which shows matching results. If you need exact search results set this to 0. For details: https://fusejs.io/api/options.html
