...
export const argTypes = {
    ...
    resetBefore: {
      description: 'if numpad has a value higher than 0 initially, first numpad click will reset the value to 0 first'
    },
    fluid: {
    ...
    disableKeyboard: {
        description: 'disable keyboard keydown events on numpad'
    },
    noAnimation: {
