<template>
  <div>
    <progress-bar :value="barModel" :color="color" :total="total" @onChange="log" />
...
<style lang="scss" scoped>
    .selectors {margin-top: 30px;
        select:not(:first-child), button:not(:first-child) {margin-left:5px;}
    }
</style>
