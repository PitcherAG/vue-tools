...
export const argTypes = {
    ...
    showLabel: {
        description: 'shows label under progress bar. Has a slot option if needed the customise label'
    },
    indicating: {
    ...
    attached: {
        description: 'Fomantic attached option. Accepts only top or bottom, however this does not work properly in some cases. You might need to customise thru css to get a better look.'
    },
    /* Slots */
    label: {
