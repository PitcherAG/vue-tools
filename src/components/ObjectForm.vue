        ...
        setup: function(props) {
            ...
            const validationError = computed(() => {
                ...
                if (!table.externalField && !props.id) {
                    ...
                    validationErrorDescription.value = $gettext('This Object does not have an external ID field in the config.json.')
                    return true
                }
                if (props.id && props.id.startsWith('PIT_') && !table.externalField) {
                    ...
                    validationErrorDescription.value =
                        $gettext('This Object does not have an external ID field in the config.json. Please provide one or sync first before editing.')
                    return true
                }
                return false
            })
